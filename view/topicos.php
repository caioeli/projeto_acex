...
<h1 class="titleCard" id="topicos">Topicos</h1>
<!-- Adicione isso onde deseja exibir o carrossel -->
<div id="carouselTopicos" class="carousel slide" data-bs-ride="carousel">

  <div class="carousel-indicators">
    <button type="button" data-bs-target="#carouselTopicos" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
    <button type="button" data-bs-target="#carouselTopicos" data-bs-slide-to="1" aria-label="Slide 2"></button>
...
<button class="carousel-control-next" type="button" data-bs-target="#carouselTopicos" data-bs-slide="next">
